...
export class UsersServiceProxy extends ServiceProxyBase {
    ...
    getUsers(state: DataSourceRequestState): Observable<GridDataResult> {
    ...
    create(model: CreateUserInputModel): Observable<void> {
    ...
    update(id: number, model: UpdateUserInputModel): Observable<void> {
    ...
    getUserTodoLists(state: DataSourceRequestState): Observable<GridDataResult> {
        const relativePath = "/api/Users/" + "todo-lists";
        let args: [string, any][] = [
        ];
        return this.fetch(relativePath, state, args);
    }
